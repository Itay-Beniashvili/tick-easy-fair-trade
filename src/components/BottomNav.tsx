            ...
            {navItems.map(({ path, icon: Icon, label }) => {
              ...
              return (
                <NavLink
                  ...
                  to={path}
                  className={cn(
                    'flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold transition-colors focus-ring',
          ...
          {navItems.map(({ path, icon: Icon, label }) => {
            ...
            return (
              <NavLink
                key={path}
                to={path}
                className="relative flex flex-col items-center gap-1 px-4 py-1.5 rounded-2xl focus-ring"
              >
                {isActive && (
                  <motion.div
                    layoutId="activeTab"
