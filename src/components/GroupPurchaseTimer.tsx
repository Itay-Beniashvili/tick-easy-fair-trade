...
import { Users, Clock, Copy, Check, X, CreditCard } from 'lucide-react';
import { cn } from '@/lib/utils';
import { GroupPurchasePayment } from './GroupPurchasePayment';
...
export function GroupPurchaseTimer({ isOpen, onClose, eventTitle, pricePerTicket = 350 }: GroupPurchaseTimerProps) {
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="w-full btn-primary-gradient py-4 rounded-2xl font-bold flex items-center justify-center gap-2 mb-4"
            >
