 ...
 export default function ManagerRegister() {
   ...
   const handleRegister = (e: React.FormEvent) => {
     e.preventDefault();
     // Mock registration - just set the role and navigate
     setRole('manager');
     navigate('/manager');
   };
   ...
   return (
     <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
       ...
       >
         ...
         <h1 className="text-3xl font-bold text-white mb-1">הצטרפו כמנהלי אירועים</h1>
         <p className="text-white/70">צרו חשבון והתחילו לנהל אירועים</p>
       </motion.div>
